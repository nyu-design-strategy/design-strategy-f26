...
4. **Run `pressure-test`** when you have a draft (it arrives through a course update around week 5). Fix what matters; run it again if you want.
...
7. **Submit** following the main README, "Submitting": PDF named `opportunity-hypothesis-<netid>.pdf` in your folder, a GitHub release tagged `oh-<netid>` with the PDF attached, and the link posted in Slack.
...
Post in the course Slack or message Teo.
