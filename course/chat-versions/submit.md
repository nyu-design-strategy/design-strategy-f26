# submit (free chat path)

*You don't need to paste this into an AI. These are the submission steps for students working through the GitHub website.*
...
To resubmit before the deadline, repeat with the tag `oh-<your-netid>-v2`. The latest link before the deadline counts.
